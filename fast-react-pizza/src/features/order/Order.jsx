...
function Order() {
  ...
  // Sometimes we want to fetch some data from another route which is not in the current page you are at and we want to do that without causing navigations
